create table Products(
  ...
  insert into Products(name, descr, price, image, type)
  values('Alesis VI61 | Advanced 61-Key USB MIDI Keyboard & Drum Pad Controller (16 Pads / 16 Knobs / 48 Buttons)', 'MIDI keyboard controller for composing digital music and playing virtual instruments, 61 full-sized, square-front, semi-weighted keys and 16 multi-color RGB backlit pads that respond to velocity and pressure, 16 knobs and 48 buttons assignable for hands-on control of your digital audio workstation, plug-ins, and instruments', 279, 'https://images-na.ssl-images-amazon.com/images/I/71euhytJRxL._SL1500_.jpg', 'keyboard');
  ...
  insert into Products(name, descr, price, image, type)
  values('KRK RP5G3-NA Rokit 5 Generation 3 Powered Studio Monitor', 'The KRK Rokit 5 Generation 3 Powered Studio Monitor takes the industry standard Rokit series to the next level! KRK’s Rokit studio monitors are the most popular choice for accurate monitoring. The Generation 3 Rokit 5 provides new waveguide optimized for superior imaging, new 1-inch soft-dome tweeters for pristine clarity, and 5-inch glass-aramid composite woofer for clear midrange and tight bass plus low and high frequency adjustment to tailor the sound for your room and mix!', 126, 'https://images-na.ssl-images-amazon.com/images/I/819n59w5RVL._SL1500_.jpg', 'speakers');
  ...
  insert into Products(name, descr, price, image, type)
    values('Gemini G4V 4-Channel Virtual DJ Controller', 'The G4V transforms the standard DJ MIDI device into a dynamic and formidable software performance controller. Within its fully metal enclosure are 2 full-featured physical DJ decks that allow complete control of 4 virtual software decks.', 350, 'https://images-na.ssl-images-amazon.com/images/I/51RlnnisfoL.jpg', 'djequip');
  ...
  insert into Products(name, descr, price, image, type)
  values('Audio-Technica ATH-M50x Professional Studio Monitor Headphones', 'Online reviewers, top audio professionals and cult followers have long agreed that the ATH-M50 is an unmatched combination of audio and build quality, whether in the studio or on the go. That award-winning formula is embodied in the newly remastered M-Series line, with a model perfectly suited for every discerning listener.', 149, 'https://images-na.ssl-images-amazon.com/images/I/91AKnvTOhvL._SL1500_.jpg', 'headphones');
  ...
  insert into Products(name, descr, price, image, type)
  values('Mixcraft Pro Studio 7', 'Record multiple MIDI and audio tracks simultaneously. Trigger auto-sync audio and MIDI clip grooves live or in the studio with Performance Panel. Loop library includes over 8900 royalty-free loops and samples in all styles. 18 pristine sounding virtual instruments, two new samplers, Alpha and Omni, and 52 professional audio effects.', 165, 'https://images-na.ssl-images-amazon.com/images/I/816ibYnpz6L._SL1500_.jpg', 'software');
